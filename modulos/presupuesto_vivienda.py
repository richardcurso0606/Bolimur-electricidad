...
def app():
    ...
    # Función auxiliar para buscar precio unitario en el DataFrame de precios
    def obtener_precio_bd(df, keywords, precio_por_defecto):
            ...
            for idx, row in df.iterrows():
                ...
                if keyword.lower() in desc:
                    try:
                        ...
                        pass
        return precio_por_defecto, False
